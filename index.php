...
<head>
    ...
    <title>FLORIDA Car Rental</title>
    <link rel="shortcut icon" type="image/png" href="assets/img/F.png">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: white">FLORIDA CAR RENTAL</h1>
                            <p class="intro-text">
        ...
        <div class="w3-row w3-padding-32 w3-section">
            ...
            <div class="w3-col m8 w3-panel">
                <div class="w3-large w3-margin-bottom">
                    <i class="fa fa-map-marker fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Florida, USA<br>
                    <i class="fa fa-phone fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Phone: +1 1236549870<br>
                    <i class="fa fa-envelope fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Email: jimmyronaldo073@gmail.com<br>
                </div>
                <p>New to FLORIDA ? Drop Your Details and Leave it on us We'll Revert</p>
